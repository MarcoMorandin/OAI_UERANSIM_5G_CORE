...
if __name__ == "__main__":
    ...
    net.addLink(mysql, s3, bw=1000, delay="1ms", intfName1="mysql-s3", intfName2="s3-mysql")

    info("*** Adding NRF container\n")
    nrf = net.addDockerHost(
        "oai-nrf",
        dimage="networking2/oai-nrf:v1.5.1",
        ip="192.168.70.136/24",
        docker_args={
            "environment": {
                "TZ": "Europe/Paris",
            ...
            "entrypoint": ["python3","/openair-nrf/bin/entrypoint.py"],
    ...
    net.addLink(nrf, s3, bw=1000, delay="1ms", intfName1="nrf-s3", intfName2="s3-nrf")
    ...
    net.addLink(udr, s3, bw=1000, delay="1ms", intfName1="udr-s3", intfName2="s3-udr")
    ...
    net.addLink(udm, s3, bw=1000, delay="1ms", intfName1="udm-s3", intfName2="s3-udm")
    ...
    net.addLink(ausf, s3, bw=1000, delay="1ms", intfName1="ausf-s3", intfName2="s3-ausf")
    ...
    amf = net.addDockerHost(
        ...
        docker_args={
            "environment": {
                ...
                # First SMF instance
                "SMF_INSTANCE_ID_0": "1",
                "SMF_IPV4_ADDRESS_0": "192.168.70.139",
                "SMF_FQDN_0": "oai-smf",
                "SELECTED_0": "true",
                "NF_REGISTRATION": "yes",
                "USE_FQDN_DNS": "yes",
                ...
                # # Other NF
                # "NRF_IPV4_ADDRESS": "192.168.70.136",
                # "NRF_FQDN": "nrf.oai-5gcn.eur",
                # "AUSF_IPV4_ADDRESS": "192.168.70.135",
                # "AUSF_FQDN": "ausf.oai-5gcn.eur",
                # "UDM_IPV4_ADDRESS": "192.168.70.134",
                # "UDM_FQDN": "udm.oai-5gcn.eur",
    ...
    net.addLink(amf, s3, bw=1000, delay="1ms", intfName1="amf-s3", intfName2="s3-amf")
    ...
    net.addLink(smf, s3, bw=1000, delay="1ms", intfName1="smf-s3", intfName2="s3-smf")
    ...
    net.addLink(ext_dn, s3, bw=1000, delay="50ms", intfName1="ext_dn-s3", intfName2="s3-ext_dn")
    ...
    # net.addLink(nssf, s3, bw=1000, delay="1ms", intfName1="nssf-s3", intfName2="s3-nssf")
